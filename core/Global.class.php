...
/*
	...
	Implemented using singleton pattern design to manage one instance to handle all session variables.
*/
class GlobalEnvironment extends Base
{
	...
	//Returns the current instance of the Session or it creates one in case it has not been created
