...
<?php	
	if (
	   (isset($_POST['slot'])) && 
	   (isset($_POST['DfirstName1'])) && 
	   (isset($_POST['DlastName1'])) && 
	   (isset($_POST['DfirstName2'])) && 
	   (isset($_POST['DlastName2'])) && 
	   (isset($_POST['Demail1'])) &&  
	   (isset($_POST['Demail2'])) && 
   	   (isset($_POST['Denglish1'])) && 
	   (isset($_POST['Denglish2'])) && 
   	   (isset($_POST['Dsex1'])) && 
	   (isset($_POST['Dsex2'])) &&
	   (isset($_POST['DpastCollab'])) &&
	...
	{  	
		...
		if ($available) 
		{
			...
			//ADDING PARTICIPANTS
			$firstName1 = stripslashes($_POST['DfirstName1']);
			$lastName1 = stripslashes($_POST['DlastName1']);
			$email1 = $_POST['Demail1'];
			$english1 = $_POST['Denglish1'];
			$sex1 = $_POST['Dsex1'];
			$firstName2 = stripslashes($_POST['DfirstName2']);
			$lastName2 = stripslashes($_POST['DlastName2']);
			$email2 = $_POST['Demail2'];
			$english2 = $_POST['Denglish2'];
			$sex2 = $_POST['Dsex2'];	
			$pastCollab = $_POST['DpastCollab'];				
			...
			$query = "INSERT INTO registrations (studyID, comments, slotID, date, time, timestamp,pastCollab) 
			          VALUES('2',:comments,:slotID,:date,:time,:timestamp,:pastCollab)";
